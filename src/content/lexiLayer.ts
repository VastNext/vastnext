...
export const lexiLayerCopy: Record<Locale, LexiLayerCopy> = {
  en: {
    ...
    hero: {
      ...
      badges: ['No Sign-up Required', '100% Free & Open Source', 'Custom AI Personas', 'Bring Your Own Key'],
    ...
    features: [
      ...
      },
      {
        ...
        title: 'Bring Your Own AI Models & Keys',
        subtitle: 'No middlemen. Your API keys stay in your browser',
        description:
          'Take control over your translation preferences and privacy. Connect any OpenAI-compatible AI service, including an endpoint you operate yourself.',
        highlights: [
  ...
  zh: {
    ...
    features: [
      ...
      },
      {
        id: 'custom-ai-models',
        badge: '隐私与自主',
        title: '自带私有 Key，自由接入任意大模型',
        subtitle: '无中间商加价，API Key 仅存放于浏览器本地',
        description:
          '掌控自己的翻译偏好与数据路径。直接接入你选择的 OpenAI 兼容 AI 服务，也可以连接你自己运行的本地端点。',
        highlights: [
          '请求直接发送到你在配置中选择的服务端点',
